...
public class powin extends JFrame{
    private Trainer trainer;
    
    public powin(Trainer trainer,Pokemon wildpokemon){
        super("Pokemon Win");
        ...
        JButton PokemonCatch = new JButton("Catch");
        ...
        PokemonCatch.addActionListener(new ActionListener(){  
            public void actionPerformed(ActionEvent e){  
                if(trainer.getpokeball() > 0){
                trainer.usepokeball();
                PokemonCatch catchP = new PokemonCatch(trainer,wildpokemon);
